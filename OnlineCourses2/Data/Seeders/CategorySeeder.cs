...
namespace OnlineCourses2.Data.Seeders
{
    public static class CategorySeeder
    {
        ...
        {
            "Психология", "Маркетинг","Музика",
            "Личностно развитие","Дизайн и креативност","Бизнес и предприемачество", 
            "Видео обработка и монтаж","Грим","Интериорен дизайн",
            "Мода и стил", "Разработка на игри","Финанси и инвестиции"
        };
